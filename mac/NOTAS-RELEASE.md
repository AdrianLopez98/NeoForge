...
- **En Ascenso, el mazo va de lo que va tu comandante.** El mazo de salida se monta con las cartas que la gente juega de verdad con ese comandante, y las cartas de premio tiran para el mismo lado: 1 de cada 3 al empezar, 2 de cada 3 en el jefe final. Sigue siendo flojo a propósito — cambia de qué va, no cuánto pega.
